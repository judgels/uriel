...
public final class ContestScoreboardUtils {
    ...
    public static void updateScoreboards(Contest contest, ContestService contestService, ContestScoreboardService contestScoreboardService, ProgrammingSubmissionService programmingSubmissionService, String userJid, String ipAddress) {
        ...
        updateScoreboard(contest, contestScoreboardService, ContestScoreboardType.OFFICIAL, submissions, adapter, state, userJid, ipAddress);
        ...
        if (contest.containsModule(ContestModules.FROZEN_SCOREBOARD)) {
            ...
            if (System.currentTimeMillis() >= freezeTime) {
                ...
                updateScoreboard(contest, contestScoreboardService, ContestScoreboardType.FROZEN, frozenSubmissions, adapter, state, userJid, ipAddress);
            }
        }
    }

    private static void updateScoreboard(Contest contest, ContestScoreboardService contestScoreboardService, ContestScoreboardType contestScoreboardType, List<ProgrammingSubmission> submissions, ScoreboardAdapter adapter, ScoreboardState state, String userJid, String ipAddress) {
