...
import org.iatoki.judgels.uriel.contest.supervisor.html.listAddSupervisorsView;
import org.iatoki.judgels.uriel.contest.supervisor.html.editSupervisorView;
    ...
    private void appendBreadcrumbsLayout(LazyHtml content, Contest contest, InternalLink... lastLinks) {
        UrielControllerUtils.getInstance().appendBreadcrumbsLayout(content,
                ContestControllerUtils.getInstance().getContestBreadcrumbsBuilder(contest)
                        .add(new InternalLink(Messages.get("supervisor.supervisors"), org.iatoki.judgels.uriel.contest.routes.ContestController.jumpToSupervisors(contest.getId())))
