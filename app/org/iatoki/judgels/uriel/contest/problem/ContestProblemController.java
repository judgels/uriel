...
import org.iatoki.judgels.uriel.contest.problem.html.addProblemView;
import org.iatoki.judgels.uriel.contest.problem.html.listProblemsView;
import org.iatoki.judgels.uriel.contest.problem.html.listUsedProblemsView;
import org.iatoki.judgels.uriel.contest.problem.html.editProblemView;
import org.iatoki.judgels.uriel.contest.problem.html.viewProblemCriticalView;
import org.iatoki.judgels.uriel.contest.problem.html.viewProblemView;
...
public class ContestProblemController extends AbstractJudgelsController {
    ...
    public Result viewProblem(long contestId, long contestProblemId) throws ContestNotFoundException, ContestProblemNotFoundException {
        ...
        param.setPostSubmitUrl(org.iatoki.judgels.uriel.contest.submission.programming.routes.ContestProgrammingSubmissionController.postSubmitProblem(contest.getId(), contestProblem.getProblemJid()).absoluteURL(request(), request().secure()));
    ...
    private void appendBreadcrumbsLayout(LazyHtml content, Contest contest, InternalLink... lastLinks) {
        UrielControllerUtils.getInstance().appendBreadcrumbsLayout(content,
                ContestControllerUtils.getInstance().getContestBreadcrumbsBuilder(contest)
                        .add(new InternalLink(Messages.get("problem.problems"), org.iatoki.judgels.uriel.contest.routes.ContestController.jumpToProblems(contest.getId())))
