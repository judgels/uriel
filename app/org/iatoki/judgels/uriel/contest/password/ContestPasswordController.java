...
import org.iatoki.judgels.uriel.contest.contestant.ContestContestantNotFoundException;
...
import org.iatoki.judgels.uriel.contest.contestant.password.html.listContestantPasswordsView;
    ...
    private void appendBreadcrumbsLayout(LazyHtml content, Contest contest, InternalLink... lastLinks) {
        UrielControllerUtils.getInstance().appendBreadcrumbsLayout(content,
                ContestControllerUtils.getInstance().getContestBreadcrumbsBuilder(contest)
                        .add(new InternalLink(Messages.get("contestant.passwords"), org.iatoki.judgels.uriel.contest.routes.ContestController.jumpToContestants(contest.getId())))
