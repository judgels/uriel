...
@Singleton
public final class ContestClarificationJedisHibernateDao extends AbstractJudgelsJedisHibernateDao<ContestClarificationModel> implements ContestClarificationDao {

    @Inject
    public ContestClarificationJedisHibernateDao(JedisPool jedisPool) {
        super(jedisPool, ContestClarificationModel.class);
    }
