...
import org.iatoki.judgels.uriel.contest.file.html.listFilesView;
    ...
    private void appendBreadcrumbsLayout(LazyHtml content, Contest contest, InternalLink... lastLinks) {
        UrielControllerUtils.getInstance().appendBreadcrumbsLayout(content,
                ContestControllerUtils.getInstance().getContestBreadcrumbsBuilder(contest)
                        .add(new InternalLink(Messages.get("file.files"), org.iatoki.judgels.uriel.contest.routes.ContestController.jumpToFiles(contest.getId())))
